    ...
    <div className={classes.Flashcards}>
      ...
      <Card className={classes.tab}>
        <div className={classes["flashcards_actions"]}>
          <NavLink activeClassName={classes['active-link']} className={classes.link} to="/flashcards/vocabulary-list">Vocabulary List</NavLink>
          <NavLink activeClassName={classes['active-link']} className={classes.link} to="/flashcards/practice">Let's Study</NavLink>
          <NavLink activeClassName={classes['active-link']} className={classes.link} to="/flashcards/learned-words">Learned Words</NavLink>
          <NavLink activeClassName={classes['active-link']} className={classes.link} to="/flashcards/difficult-words">Difficult Words</NavLink>
        </div>
        {!hasContent && <div className={classes.empty}>
